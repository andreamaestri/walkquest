...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(db_index=True, default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('walk_id', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['walk_id'], name='walks_walk_walk_id_f17be5_idx'), models.Index(fields=['walk_name'], name='walks_walk_walk_na_61e115_idx'), models.Index(fields=['distance'], name='walks_walk_distanc_454717_idx'), models.Index(fields=['created_at'], name='walks_walk_created_de3203_idx')],
            },
        ),
    ]
